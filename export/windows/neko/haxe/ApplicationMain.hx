...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Alejandro Ramallo", "LD41", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LD41", null, { width: 800, height: 600 });
