...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/crosshair.png", __ASSET__assets_images_crosshair_png);
		type.set ("assets/images/crosshair.png", AssetType.IMAGE);
		...
		className.set ("assets/images/shards.png", __ASSET__assets_images_shards_png);
		type.set ("assets/images/shards.png", AssetType.IMAGE);
		className.set ("assets/images/xpl.png", __ASSET__assets_images_xpl_png);
		type.set ("assets/images/xpl.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/crosshair.png";
		path.set (id, id);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/shards.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/xpl.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_crosshair_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_shards_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_xpl_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/crosshair.png") #if display private #end class __ASSET__assets_images_crosshair_png extends lime.graphics.Image {}
...
@:image("assets/images/shards.png") #if display private #end class __ASSET__assets_images_shards_png extends lime.graphics.Image {}
@:image("assets/images/xpl.png") #if display private #end class __ASSET__assets_images_xpl_png extends lime.graphics.Image {}
